        ...
        <form action="/register/save" method="post" class="register-form">
            ...
            <div class="form-row">
                <div class="form-group" id="regis0">
                    ...
                    <input type="date" name="stuID" id="date" placeholder="" required="" value="<?= set_value('stuID'); ?>">
                </div>
                <div class="form-group" >
            ...
            <div class="form-row">
                ...
                <div class="form-group" id="regis0">
                    ...
                    <input style="width: 98px;" type="text" name="stuID" id="date" required="" value="<?= set_value('stuID'); ?>">
                </div>
                <div class="form-group">
